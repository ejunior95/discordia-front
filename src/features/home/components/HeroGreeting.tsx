...
import { MessagesSquare, Gamepad2, Sparkles } from 'lucide-react';
...
export function HeroGreeting() {
  ...
  return (
    <section className="relative overflow-hidden rounded-2xl border bg-gradient-to-br from-primary/10 via-background to-background p-6 md:p-10">
